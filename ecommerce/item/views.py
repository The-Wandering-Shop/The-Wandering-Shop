...
def items(request):
    """Displays all new items with optional filtering by category or search query."""
...
def detail(request, pk):
    ...
    related_items = Item.objects.filter(catergory=item.catergory, is_new=False).exclude(pk=pk)[0:3]
