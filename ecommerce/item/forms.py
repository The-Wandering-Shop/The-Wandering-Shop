...
class NewItemForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('catergory', 'name', 'description', 'price', 'image', 'is_new') # Fields in the form

        widgets = {
            'catergory' : forms.Select(attrs={
            'class' : INPUT_CLASSES
            }),
...
class EditItemForm(forms.ModelForm):
    ...
    class Meta:
        model = Item # Connects the form to the Item model
        fields = ('name', 'description', 'price', 'image','is_new') # Fields that can be edited
